...
const Meta = (props) => {
    return (
        <Head>
            ...
            <meta property="og:image" itemProp="image" content="https://i.ibb.co/1zNsK8G/mcmendel.jpg" />
            <meta property="og:description" content="McMendel Energy is an energy provision and a global warming and climate change advocate company aspiring to change the face of energy using green energy. The Company is driven by its vision of making an impact in the energy sector of Ghana and Africa, which inspires, motivates and keeps the Firm focused on doing what really matters." />
            ...
            <meta property="og:url" content="http://mcmendelenergy.com" />
            ...
            <link rel='shortcut icon' href='/mcmndl.png' />
